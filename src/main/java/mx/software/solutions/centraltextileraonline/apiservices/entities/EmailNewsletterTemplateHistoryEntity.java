...
@Data
@Entity
@Table(name = "\"EmailNewsletterTemplateHistory\"")
public class EmailNewsletterTemplateHistoryEntity {
	...
	@JoinColumn(name = "\"email_newsletter_template\"")
	private EmailNewsletterTemplateEntity emailNewsletterTemplateEntity;
